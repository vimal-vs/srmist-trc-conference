    ...
    <>
      <div className="relative w-full min-h-[50vh] md:min-h-[60vh]">
        ...
        <Image
          src={landingBg}
          alt="bg"
          className="object-cover w-full min-h-[50vh] md:min-h-[60vh]"
        />
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          ...
          <div className="text-white z-10 text-center pt-4 space-y-3 mt-2 md:space-y-6">
            ...
            <Link
              href={""}
              className="flex justify-center items-center gap-3 font-medium text-sm md:text-xl"
            >
          ...
          <div className="z-10 mt-4 md:mt-8">
            <Button
              ...
              className="bg-pink-600 text-white border-0 text-lg px-6 py-6 hover:bg-pink-700 hover:text-white flex justify-center items-center gap-2"
            >
              Register
